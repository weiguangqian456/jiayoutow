...
/**
 *
 * ClassName:      ReimbOrderFragment
 * <p>
 * Author:
 * <p>
 * CreateDate:      2020/9/24 11:15
 * <p>
 * Description:
 */

class ReimbOrderFragment : BaseMvpFragment(){
    // 请求数据
    ...
    override val layoutId: Int
        get() = R.layout.order_reimb_fragmet

    override fun initView(view: View?, savedInstanceState: Bundle?) {
        Inform_Target = PublicPresenter(context, false, "")
        Inform_Target?.attachView(this)

        var rvodeer = view?.findViewById<SwipeRecyclerView>(R.id.rv_all_order)
    ...
    fun newData() {
        Inform_Target?.netWorkRequestGet(HttpURL.OrderZhuBangquery, HttpRequest.OrderRefurlist(MyApplication.MOBILE, "10", mHttpPage.toString(), "8.3.11", "已退款"))
